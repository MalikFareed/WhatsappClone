...
import com.malik.whatsappclone.Chat.MessageAdapter;
import com.malik.whatsappclone.Chat.MessageObject;
...
public class ChatActivity extends AppCompatActivity {
    ...
    private void sendMessage() {
        EditText mMessage = findViewById(R.id.txtMessage);
    ...
    private void initializeRecyclerView() {
        ...
        mChat = findViewById(R.id.messagesRecyclerView);
